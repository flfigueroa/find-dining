					        		...
					        		if (this.state.filter_key === filter_cat){
					        			return <div className="result-row" key={shop.restaurant_id}>
		        			        		...
		        			        		<div className= "result-col2">
								        		...
								        		<div className="result-cuisine">{shop.restaurant_cuisine} | {shop.restaurant_type}</div>
			        		        			
			        			        		<div className="result-address">{shop.restaurant_address}</div>
			        			        	</div>
								...
								{this.state.search_results.map((shop) => {
				        			return <div className="result-row" key={shop.restaurant_id}>
	        			        		...
	        			        		<div className= "result-col2">
							        		...
							        		<div className="result-cuisine">{shop.restaurant_cuisine} | {shop.restaurant_type}</div>
		        			        		<div className="result-price">{shop.restaurant_price}</div>
		        			        		<div className="result-days">{shop.restaurant_days}</div>
		        			        		<div className="result-hours">{shop.restaurant_openingtime}:{shop.restaurant_closingtime}</div>
		        			        		<div className="result-address">{shop.restaurant_address}</div>
			        			        </div>
								        	<div className="result-rates">
								        		<div className="result-data">{shop.restaurant_likes}</div>
